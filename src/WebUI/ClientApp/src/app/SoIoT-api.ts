...
export class DevicesClient implements IDevicesClient {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<DevicesVm>><any>_observableThrow(e);
                }
            } else
                return <Observable<DevicesVm>><any>_observableThrow(response_);
        }));
    }

    protected processGet(response: HttpResponseBase): Observable<DevicesVm> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = DevicesVm.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<DevicesVm>(<any>null);
    }
    ...
    getDeviceLog(sensorId: string | null): Observable<DeviceLogsVm> {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetDeviceLog(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetDeviceLog(<any>response_);
                } catch (e) {
                    return <Observable<DeviceLogsVm>><any>_observableThrow(e);
                }
            } else
                return <Observable<DeviceLogsVm>><any>_observableThrow(response_);
        }));
    }

    protected processGetDeviceLog(response: HttpResponseBase): Observable<DeviceLogsVm> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = DeviceLogsVm.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
...
export class CreateDeviceItemCommand implements ICreateDeviceItemCommand {
    ...
    static fromJS(data: any): CreateDeviceItemCommand {
        data = typeof data === 'object' ? data : {};
        let result = new CreateDeviceItemCommand();
        result.init(data);
        return result;
    }
...
export class DevicesVm implements IDevicesVm {
    lists?: DevicesDto[] | undefined;

    constructor(data?: IDevicesVm) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
        ...
        if (_data) {
            if (Array.isArray(_data["lists"])) {
                ...
                for (let item of _data["lists"])
                    this.lists!.push(DevicesDto.fromJS(item));
            }
        }
    }

    static fromJS(data: any): DevicesVm {
        data = typeof data === 'object' ? data : {};
        let result = new DevicesVm();
        result.init(data);
        return result;
    }
...
export class DevicesDto implements IDevicesDto {
    ...
    static fromJS(data: any): DevicesDto {
        data = typeof data === 'object' ? data : {};
        let result = new DevicesDto();
        result.init(data);
        return result;
    }
...
export class DeviceLogsVm implements IDeviceLogsVm {
    ...
    static fromJS(data: any): DeviceLogsVm {
        data = typeof data === 'object' ? data : {};
        let result = new DeviceLogsVm();
        result.init(data);
        return result;
    }
...
export class SensorLogsDto implements ISensorLogsDto {
    ...
    static fromJS(data: any): SensorLogsDto {
        data = typeof data === 'object' ? data : {};
        let result = new SensorLogsDto();
        result.init(data);
        return result;
    }
